...
public class Signinpage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TOURIST GUIDE APP ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean a = false;
        boolean b = false;
        if(jTextField1.getText().trim().matches("^[A-Za-z]{2,30}$")){
            System.out.println(jTextField1.getText());
            a = true;
        }
        
        if(!(jTextField2.getText().trim().matches(""))){
            System.out.println(jTextField2.getText());
            b = true;
        }
        if(!(a&&b)){
            JOptionPane.showMessageDialog(this,"Please Enter correct Credential!!","Message",JOptionPane.ERROR_MESSAGE);
        }
